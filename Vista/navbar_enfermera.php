...
<!-- Navbar Enfermera - Barra Lateral -->
<nav id="sidebar" class="sidebar bg-light p-3">
    <div class="sidebar-sticky">
        <a class="navbar-brand" href="dashboard_enfermera.php">
        ...
        <ul class="nav flex-column mt-3">
            ...
            <li class="nav-item">
                ...
                <ul class="collapse list-unstyled" id="consultasSubmenu">
                    <li><a class="nav-link" href="calendario_citas.php"><i class="fas fa-calendar-alt"></i> Calendario de Citas</a></li>
                    <li><a class="nav-link" href="detalle_historial_clinico.php"><i class="fas fa-book-medical"></i> Generar Historial Clínico</a></li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="#registrosSubmenu" data-bs-toggle="collapse" aria-expanded="false">
                    <i class="fas fa-notes-medical"></i> Registros
                </a>
                <ul class="collapse list-unstyled" id="registrosSubmenu">
                    <li><a class="nav-link" href="registro_atencion.php"><i class="fas fa-file-medical"></i> Registro de Atención</a></li>
                    <li><a class="nav-link" href="registro_signos_vitales.php"><i class="fas fa-heartbeat"></i> Registro de Signos Vitales</a></li>
                </ul>
            </li>

            <!-- Usuario y Logout -->
            <li class="nav-item">
                <a class="nav-link" href="#"><i class="fas fa-user-nurse"></i> ENFERMERA</a>
            </li>
            <li class="nav-item">
